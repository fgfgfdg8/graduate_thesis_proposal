...
揭示Agent系统已逐步进入办公自动化、软件工程、网络安全运维、数据分析和智能物联网等关键应用领域\cite{park2023generative}；
...
Windows Agent Arena\cite{bonatti2025windows}等基准显示，真实环境中的Agent任务通常呈现长时序、跨应用和多工具组合特征。
...
Imprompter\cite{fu2024imprompter}、CaMeL\cite{debenedetti2025camel}、FIDES\cite{costa2025fides}、
