...
\toprule
\raggedright\arraybackslash\textbf{域} & \raggedright\arraybackslash\textbf{UT编号} & \raggedright\arraybackslash\textbf{用户指令} & \raggedright\arraybackslash\textbf{Ground Truth Output} & \raggedright\arraybackslash\textbf{步数} \\
\midrule
\multirow{3}{*}{银行}
