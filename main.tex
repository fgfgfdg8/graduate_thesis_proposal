...
\title{面向大语言模型智能体工具调用链的威胁归因与防御方法研究} % 文档元信息标题
% \author{吴丰艺}
% \date{2026年5月}
\date{} % 不在正文自动生成日期
...
\newcommand{\ThesisTitle}{面向大语言模型智能体工具调用链的威胁归因与防御方法研究} % 开题报告论文题目
...
\newcommand{\ProposalDate}{2026 年 5 月 30 日} % 开题报告日期
